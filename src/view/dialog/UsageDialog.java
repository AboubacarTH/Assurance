...
public class UsageDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public UsageDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public UsageDialog(java.awt.Frame parent, boolean modal, Usage usage) {
        super(parent, modal);
        this.usage = usage;
        initComponents();
        textField_usage.setText(this.usage.getUsage());
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(textField_usage, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            UsageDialog dialog = new UsageDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField textField_usage;
    // End of variables declaration//GEN-END:variables
    private void ajouter_usage() {
        if (textField_usage.getText().isBlank()) {
            warning_information();
            return;
        }
        if (usage == null) {
