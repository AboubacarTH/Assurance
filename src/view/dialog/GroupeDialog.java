 ...
 * @author ATH
 */
public class GroupeDialog extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public GroupeDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public GroupeDialog(java.awt.Frame parent, boolean modal, Groupe groupe) {
        super(parent, modal);
        this.groupe = groupe;
        initComponents();
        textField_groupe.setValue(this.groupe.getId());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numéro groupe");

        textField_groupe.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(java.text.NumberFormat.getIntegerInstance())));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel1)
                    .addComponent(textField_groupe, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            GroupeDialog dialog = new GroupeDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JFormattedTextField textField_groupe;
    // End of variables declaration//GEN-END:variables
    private void ajouter_groupe() {
        if (textField_groupe.getText().isBlank()) {
            warning_information();
            return;
        }
        long id;
        try {
            id = Long.parseLong(textField_groupe.getText());
